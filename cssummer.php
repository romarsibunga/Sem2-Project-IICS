					...
					<!-- Nav -->
						<nav id="nav">
							<ul>
								...
								<li class="current"><a href="cs.html">CS</a>
								<ul>
...
$sql = "SELECT * FROM subjects where semcode='CSSUMMER001' ORDER BY subjectcode";
...
?>
								...
								<center><ul class="actions">
									<td style="border-style:hidden;"><a href="1stcs.php" class="button big">1st year CS Curriculum</a></td>
									<td style="border-style:hidden;"><a href="2ndcs.php" class="button big">2nd year CS Curriculum</a></td></tr>
                                                                         <tr><td style="border-style:hidden;"><a href="3rdcs.php" class="button big">3rd year CS Curriculum</a></td>
									<td style="border-style:hidden;"><a href="4thcs.php" class="button big">4th year CS Curriculum</a></td>
								</ul></center>
					...
					<div class="row">
						<div class="12u">
							...
							<!-- Copyright -->
								<div id="copyright">
									<ul class="links">
										<table style="border-style:hidden;"><tr><td style="border-style:hidden;"><a href="#">UST Website</a></td><td style="border-style:hidden;">&nbsp;&nbsp;&nbsp;</td><td style="border-style:hidden;"><a href="#"> Contact Info</a></td></tr></table>
									</ul>
								</div>
