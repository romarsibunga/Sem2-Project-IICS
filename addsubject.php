...
<a href="subjects.php"><img src="images/back.png" title="BACK"></a><br><br>
...
<tr><td>SUBJECT CODE :</td><td><input type="text" name="subjectcode" size="25"></td></tr>
<tr><td>DESCRIPTION :</td><td><input type="text" name="desc" size="25"></td></tr>
<tr><td>LECTURE :</td><td>
<select name="lec">
	<option>0</option>
	<option>1</option>
...
<tr><td>PRE-REQUISITE :</td><td>
<input type="text" name="prereq" size="25">
</td></tr>
