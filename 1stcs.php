...
<a href="#" class="button icon fa-file-text">VIEW TUITION</a><p>
<table>
<tr>
							<th>SUBJECT</th>
							<th>DESCRIPTION</th>
...
$sql = "SELECT * FROM subjects where semcode='CSY1SEM001' ORDER BY subjectcode";
...
$sql = "SELECT * FROM subjects where semcode='CSY1SEM002' ORDER BY subjectcode";
$result = $conn->query($sql);
