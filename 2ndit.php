...
$sql = "SELECT * FROM subjects where semcode='ITY2SEM001' ORDER BY subjectcode";
...
$sql = "SELECT * FROM subjects where semcode='ITY2SEM002' ORDER BY subjectcode";
$result = $conn->query($sql);
...
?>
								...
								<center><ul class="actions">
									<td style="border-style:hidden;"><a href="1stit.php" class="button big">1st year IT Curriculum</a></td>
									<td style="border-style:hidden;"><a href="2ndit.php" class="button big">2nd year IT Curriculum</a></td></tr>
                                                                         <tr><td style="border-style:hidden;"><a href="3rdit.php" class="button big">3rd year IT Curriculum</a></td>
									<td style="border-style:hidden;"><a href="4thit.php" class="button big">4th year IT Curriculum</a></td>
								</ul></center>
